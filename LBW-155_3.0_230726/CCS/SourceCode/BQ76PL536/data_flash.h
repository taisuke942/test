...
#define NUMBER_OF_BQ_DEVICES      2  //3 BQ76PL536 devices are connected
#define NUMBER_OF_CELLS           8 //MAX number of cells in the system
#define MAX_CELLS_NUMBER_IN_BQ    4  //MAX number of cells per BQ76PL536 device
#define CELL_BALANCING_EN         1  //set to 1 to enable cell balancing
#define ONE_MINUTE                     60

//Battery pack information and threshold values
#define dCOV_THRESHOLD                 3750  //COV_THRESHOLD           [mV]
#define dCOV_RECOVERY_THRESHOLD        3700  //COV_RECOVERY_THRESHOLD  [mV]
#define dCOV_TIME                      1 //20 //COV_TIME (max value 32) [100ms]
#define dCUV_THRESHOLD                 2300  //CUV_THRESHOLD           [mV]
#define dCUV_RECOVERY_THRESHOLD        2400  //CUV_RECOVERY_THRESHOLD  [mV]
...
#define dCC_CV_QUAL_TIME               10    //CC_CV_QUAL_TIME              [s]
//PACK_END_OF_DISCHARGE_VOLTAGE[mV]
#define dPACK_END_OF_DISCHARGE_VOLTAGE (DWORD)dCUV_THRESHOLD*NUMBER_OF_CELLS 
#define dEND_OF_DISCHARGE_QUAL_TIME    10    //END_OF_DISCHARGE_QUAL_TIME   [s]

#define dCHARGE_CURRENT                500  //CHARGE_CURRENT               [mA]
#define dCHARGE_TAPER_CURRENT          200   //CHARGE_TAPER_CURRENT         [mA]
#define dCHARGE_TAPER_TIME             (DWORD)1*ONE_MINUTE//CHARGE_TAPER_TIME[s]
#define dMAX_CHARGE_TIME               (DWORD)5*ONE_MINUTE//MAX_CHARGE_TIME  [s]
...
#define dCHARGE_DISCHARGE_TIME         10   //CHARGE_DISCHARGE_TIME [s]
...
#define dSOV_TIME                      300  //SOV_TIME                     [ms]

#define dCELL_IMBALANCE_FAIL_THRESHOLD 300   //CELL_IMBALANCE_FAIL_THRESHOLD[mV]
#define dCELL_IMBALANCE_FAIL_TIME      (DWORD)50*ONE_MINUTE//CELL_IMBALANCE_FAIL_TIME[s]
...
#define dMAX_BALANCE_TIME              (DWORD)20*ONE_MINUTE//MAX_BALANCE_TIME[s]
