...
#define ADC_CONTROL_VAL_6 ((0<<6)|(1<<4)|(0<<3)|(5<<0))
#define ADC_CONTROL_VAL_5 ((0<<6)|(1<<4)|(0<<3)|(4<<0))
#define ADC_CONTROL_VAL_4 ((0<<6)|(1<<4)|(0<<3)|(3<<0))   // mod 120808

//AUX,GPIO_OUT,GPIO_IN,SLEEP,TS2,TS1
#define IO_CONTROL_VAL    ((0<<7)|(0<<6)|(0<<5)|(0<<2)|(0<<1)|(1<<0))
#endif
...
#define CONFIG_OT_VAL     ((6<<4)|(6<<0))/*TS2*/  // mod.by S.tei 120720
