...
#define dLOW_POWER_THERESHOLD          2100  //LOW_POWER_THERESHOLD  [mV]  LPM4 //2023.04.26 LPM4に入る電圧
...
#define dCELL_IMBALANCE_FAIL_THRESHOLD 50000   //CELL_IMBALANCE_FAIL_THRESHOLD[mV] //20230426 Fauitを回避する為に5000にした
#define dCELL_IMBALANCE_FAULT_V        300     //CELL_IMBALANCE_FAULT_V[mV] //20230608 Fauit信号が必要なので追加 0.5V→0.3Vに変更 20230613
...
typedef enum PARAM_ID
{
  ...
  CUV_TIME,
  LOW_POWER_THERESHOLD,         //20230525追加　
