...
*
*  @author S.tei  MIGHT INDUSTRY Co.ÅCLtd
*  @date May 2017
*  @version 1.0  version
...
#define OUT_BQ_CONV           BIT4 //Port X.4
...
#define IN_BQ_DRDY             BIT3 //PORTx.3
#define IN_BQ_ALERT            BIT2 //PORTx.2
#define IN_BQ_FAULT            BIT1 //PORTx.1
// add TEMP(P2.4)  120704 by S.tei
#define BQ76PL536_TEMP_PxIN   P2IN
#define BQ76PL536_TEMP_PxOUT  P2OUT
#define BQ76PL536_TEMP_PxDIR  P2DIR
#define BQ76PL536_TEMP_PxIFG  P2IFG
#define BQ76PL536_TEMP_PxIES  P2IES
#define BQ76PL536_TEMP_PxIE   P2IE
#define BQ76PL536_TEMP_PxSEL  P2SEL
#define BQ76PL536_TEMP_PxREN  P2REN
#define OUT_BQ_TEMP BIT4
// add FAULT_O (P2.3)  120704 by S.tei
#define BQ76PL536_FAULT_O_PxIN   P2IN
#define BQ76PL536_FAULT_O_PxOUT  P2OUT
#define BQ76PL536_FAULT_O_PxDIR  P2DIR
#define BQ76PL536_FAULT_O_PxIFG  P2IFG
#define BQ76PL536_FAULT_O_PxIES  P2IES
#define BQ76PL536_FAULT_O_PxIE   P2IE
#define BQ76PL536_FAULT_O_PxSEL  P2SEL
#define BQ76PL536_FAULT_O_PxREN  P2REN
#define OUT_BQ_FAULT_O BIT3
// add OV port (P2.5)  120704 by S.tei
#define BQ76PL536_OV_PxIN   P2IN
#define BQ76PL536_OV_PxOUT  P2OUT
#define BQ76PL536_OV_PxDIR  P2DIR
#define BQ76PL536_OV_PxIFG  P2IFG
#define BQ76PL536_OV_PxIES  P2IES
#define BQ76PL536_OV_PxIE   P2IE
#define BQ76PL536_OV_PxSEL  P2SEL
#define BQ76PL536_OV_PxREN  P2REN
#define OUT_BQ_OV BIT5


//ADC_ON, TS2&TS1, GPAI, Cells 1-2-3.....
#if (LOW_POWER_MODE==LPM0_bits)   // add #if #endif  120903
#define ADC_CONTROL_VAL_6 ((0<<6)|(0<<4)|(0<<3)|(5<<0))
#define ADC_CONTROL_VAL_5 ((0<<6)|(0<<4)|(0<<3)|(4<<0))
#define ADC_CONTROL_VAL_4 ((0<<6)|(0<<4)|(0<<3)|(3<<0))   // mod 120808

//AUX,GPIO_OUT,GPIO_IN,SLEEP,TS2,TS1
#define IO_CONTROL_VAL    ((0<<7)|(0<<6)|(0<<5)|(0<<2)|(0<<1)|(0<<0))    // mod 2017.04.04
#endif

#if (LOW_POWER_MODE==LPM3_bits)   // add #if #endif  120903
#define ADC_CONTROL_VAL_6 ((0<<6)|(0<<4)|(0<<3)|(5<<0))
#define ADC_CONTROL_VAL_5 ((0<<6)|(0<<4)|(0<<3)|(4<<0))
#define ADC_CONTROL_VAL_4 ((0<<6)|(0<<4)|(0<<3)|(3<<0))   // mod 120808
...
#if (LOW_POWER_MODE==LPM4_bits)   // add #if #endif  120903
#define ADC_CONTROL_VAL_6 ((0<<6)|(0<<4)|(0<<3)|(5<<0))
#define ADC_CONTROL_VAL_5 ((0<<6)|(0<<4)|(0<<3)|(4<<0))
#define ADC_CONTROL_VAL_4 ((0<<6)|(0<<4)|(0<<3)|(3<<0))   // mod 120808
...
#define IO_CONFIG_VAL     (1<<0)                    // mod 2017.04.07
...
#define CONFIG_OT_VAL     ((7<<4)|(7<<0))/*TS2*/  // mod.by S.tei 120720    // mod 2017.04.04
...
typedef struct BQ_PACK
{
  ...
  unsigned short uv_lowest_data_count;           // add 2021.06.08
  unsigned short uv_lowest_dim[100];             // add 2021.06.08
  unsigned short uv_lowest_average_count;        // add 2021.06.08
  unsigned long int uv_lowest_total_Volt;        // add 2021.06.08
  unsigned short uv_lowest_average_Volt;         // add 2021.06.08
  unsigned short ov_output_delay_timer;          // add 2021.05.18
  unsigned short uv_output_delay_timer;          // add 2021.05.18
  unsigned short uv_output_hold_F;               // add 2021.05.18
  unsigned short uv_output_hold_timer;           // add 2021.05.18
} bq_pack_t;
