...
//    DMA0DAL = (unsigned int)dest;   // set destination for DMAx
    DMA0DAL = (unsigned int)(uintptr_t)dest;   // set destination for DMAx
//    DMA0SAL = (WORD)source; // set source for DMAx
    DMA0SAL = (unsigned int)(uintptr_t)source; // set source for DMAx
...
//    DMA1DAL = (WORD)dest;   // set destination for DMAx
    DMA1DAL = (unsigned int)(uintptr_t)dest;   // set destination for DMAx
//    DMA1SAL = (WORD)source; // set source for DMAx
    DMA1SAL = (unsigned int)(uintptr_t)source; // set source for DMAx
...
//    DMA2DAL = (WORD)dest;   // set destination for DMAx
    DMA2DAL = (unsigned int)(uintptr_t)dest;   // set destination for DMAx
//    DMA2SAL = (WORD)source; // set source for DMAx
    DMA2SAL = (unsigned int)(uintptr_t)source; // set source for DMAx
